...
# --- SURVIVOR: NUM_BOUNDARY_2312 (HIGH) line 2312 in q_wrap() ---
...
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_2312 line 2312 in q_wrap()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 2312 in q_wrap() to detect the mutant
    fail('NUM_BOUNDARY_2312: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_3049 (HIGH) line 3049 in _schema_to_lectrotest_generator() ---
# Source:  if ($max == 0) {
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3049 line 3049 in _schema_to_lectrotest_generator()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 3049 in _schema_to_lectrotest_generator() to detect the mutant
    fail('NUM_BOUNDARY_3049: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_3052 (HIGH) line 3052 in _schema_to_lectrotest_generator() ---
# Source:  } elsif ($max > 0) {
# Hint:    Likely missing edge-case test (boundary value)
...
#   Numeric boundary flip > to ==
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3052 line 3052 in _schema_to_lectrotest_generator()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 3052 in _schema_to_lectrotest_generator() to detect the mutant
    fail('NUM_BOUNDARY_3052: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_3061 (HIGH) line 3061 in _schema_to_lectrotest_generator() ---
# Source:  if ($min == 0) {
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3061 line 3061 in _schema_to_lectrotest_generator()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 3061 in _schema_to_lectrotest_generator() to detect the mutant
    fail('NUM_BOUNDARY_3061: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_3064 (HIGH) line 3064 in _schema_to_lectrotest_generator() ---
# Source:  } elsif ($min > 0) {
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (4 variants — one test should kill all):
#   Numeric boundary flip > to <
...
#   Numeric boundary flip > to ==
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3064 line 3064 in _schema_to_lectrotest_generator()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 3064 in _schema_to_lectrotest_generator() to detect the mutant
    fail('NUM_BOUNDARY_3064: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_3074 (HIGH) line 3074 in _schema_to_lectrotest_generator() ---
# Source:  if ($range <= 0) {
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip <= to <
...
#   Numeric boundary flip <= to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3074 line 3074 in _schema_to_lectrotest_generator()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator');
    # TODO: exercise line 3074 in _schema_to_lectrotest_generator() to detect the mutant
    fail('NUM_BOUNDARY_3074: replace with real assertion');
}
