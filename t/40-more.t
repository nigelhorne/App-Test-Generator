...
subtest 'builtin functions' => sub {
	...
	generate($builtin_conf, $builtin_t);
...
subtest 'empty new configuration' => sub {
	...
	generate($empty_new_conf, $empty_new_t);
...
subtest 'edge_case_array' => sub {
	...
	generate($edge_array_conf, $edge_array_t);
