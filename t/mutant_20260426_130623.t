...
TODO: {
    ...
    # NOTE: App::Test::Generator::Mutation::ConditionalInversion has no constructor — call class methods directly.
    # e.g. my $result = App::Test::Generator::Mutation::ConditionalInversion->method(...);
...
TODO: {
    ...
    # NOTE: App::Test::Generator::Mutation::NumericBoundary has no constructor — call class methods directly.
    # e.g. my $result = App::Test::Generator::Mutation::NumericBoundary->method(...);
...
# --- SURVIVOR: BOOL_NEGATE_199_7 (MEDIUM) line 199 in mutate() ---
# Source:  return 0 unless $node->isa('PPI::Statement::Break');
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_199_7 line 199 in mutate()';
    ...
    # TODO: exercise line 199 in mutate() to detect the mutant
    fail('BOOL_NEGATE_199_7: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_199_7 line 199 in mutate() ---
# Source:  return 0 unless $node->isa('PPI::Statement::Break');
...
# NOTE: App::Test::Generator::Mutation::ReturnUndef has no constructor — call class methods directly.
# e.g. my $result = App::Test::Generator::Mutation::ReturnUndef->method(...);
# ok($result, 'RETURN_UNDEF_199_7: add assertion here');
