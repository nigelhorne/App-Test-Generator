...
# --- SURVIVOR: NUM_BOUNDARY_3832_23_> (HIGH) line 3832 in _analyze_output_from_code() ---
...
#   Numeric boundary flip >= to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_3832_23_> line 3832 in _analyze_output_from_code()';
    # Suggested boundary values to test: 1, 2, 3
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 3832 in _analyze_output_from_code() to detect the mutant
    fail('NUM_BOUNDARY_3832_23_>: replace with real assertion');
}
