...
# --- SURVIVOR: COND_INV_6618_3 (MEDIUM) line 6618 in _module_constants() ---
# Source:  return \%c;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6618_3 line 6618 in _module_constants()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6618 in _module_constants() to detect the mutant
    fail('COND_INV_6618_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6646_3 (MEDIUM) line 6646 in _module_constants() ---
# Source:  # Entry:      $p_ref - reference to the parameter
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6646_3 line 6646 in _module_constants()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6646 in _module_constants() to detect the mutant
    fail('COND_INV_6646_3: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_6649_52_> (HIGH) line 6649 in _module_constants() ---
...
#   Numeric boundary flip < to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_6649_52_> line 6649 in _module_constants()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6649 in _module_constants() to detect the mutant
    fail('NUM_BOUNDARY_6649_52_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_6652_52_< (HIGH) line 6652 in _module_constants() ---
# Source:  #             referenced parameter hashref.
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip > to <
#   Numeric boundary flip > to >=
...
# Source:  $self->_log("  CODE: $param matches pattern: $p->{matches}");
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  #             $sig  - hashref of parameters from
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  #             lowest position winning ties. Optional
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_6956_3 (MEDIUM) line 6956 in _determine_optional_status() ---
# Source:  sub _determine_optional_status {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6956_3 line 6956 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6956 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6956_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6957_4 (MEDIUM) line 6957 in _determine_optional_status() ---
# Source:  my ($self, $merged_param, $pod_param, $code_param) = @_;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6957_4 line 6957 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6957 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6957_4: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6972_3 (MEDIUM) line 6972 in _determine_optional_status() ---
# Source:  $merged_param->{optional} = 0;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6972_3 line 6972 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6972 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6972_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6976_3 (MEDIUM) line 6976 in _determine_optional_status() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6976_3 line 6976 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6976 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6976_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6980_3 (MEDIUM) line 6980 in _determine_optional_status() ---
# Source:  #
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6980_3 line 6980 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6980 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6980_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6984_3 (MEDIUM) line 6984 in _determine_optional_status() ---
# Source:  #             and semantic information was inferred
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6984_3 line 6984 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6984 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6984_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6988_3 (MEDIUM) line 6988 in _determine_optional_status() ---
# Source:  #                       specs as produced by
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6988_3 line 6988 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6988 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6988_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_6994_3 (MEDIUM) line 6994 in _determine_optional_status() ---
# Source:  #                               medium, high
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_6994_3 line 6994 in _determine_optional_status()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 6994 in _determine_optional_status() to detect the mutant
    fail('COND_INV_6994_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_7000_3 (MEDIUM) line 7000 in _determine_optional_status() ---
# Source:  #               per_parameter - hashref of per-
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  push @param_factors, "Type: $p->{type} (+30)";
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (4 variants — one test should kill all):
#   Numeric boundary flip > to <
#   Numeric boundary flip > to >=
...
# Source:  push @param_factors, 'Has min constraint (+15)';
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip >= to >
#   Numeric boundary flip >= to <
...
# Source:  push @factors, "Medium confidence: return type defined";
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_7282_3 (MEDIUM) line 7282 in _generate_confidence_report() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
    local $TODO = 'Complete: COND_INV_7282_3 line 7282 in _generate_confidence_report()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 7282 in _generate_confidence_report() to detect the mutant
    fail('COND_INV_7282_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_7509_6 (MEDIUM) line 7509 in _deduplicate_relationships() ---
# Source:  unless ($seen{$sig}++) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_7509_6 line 7509 in _deduplicate_relationships()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 7509 in _deduplicate_relationships() to detect the mutant
    fail('COND_INV_7509_6: replace with real assertion');
}

# --- SURVIVOR: COND_INV_7593_6 (MEDIUM) line 7593 in _detect_mutually_exclusive() ---
# Source:  $self->_log("  RELATIONSHIP: $param1 and $param2 are mutually exclusive (from error message)");
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_7782_4 (MEDIUM) line 7782 in _detect_dependencies() ---
# Source:  foreach my $param1 (@$param_names) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_7782_4 line 7782 in _detect_dependencies()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 7782 in _detect_dependencies() to detect the mutant
    fail('COND_INV_7782_4: replace with real assertion');
}

# --- SURVIVOR: COND_INV_7884_4 (MEDIUM) line 7884 in _detect_value_constraints() ---
# Source:  # Write a single method schema to a YAML file in output_dir.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Add relationships if detected
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  #             short human-readable description
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_8291_3 (MEDIUM) line 8291 in _format_relationship() ---
# Source:  } elsif ($rel->{type} eq 'dependency') {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_8291_3 line 8291 in _format_relationship()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8291 in _format_relationship() to detect the mutant
    fail('BOOL_NEGATE_8291_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_8293_2 (MEDIUM) line 8293 in _format_relationship() ---
# Source:  } elsif ($rel->{type} eq 'value_constraint') {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8293_2 line 8293 in _format_relationship()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8293 in _format_relationship() to detect the mutant
    fail('COND_INV_8293_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_8304_2 (MEDIUM) line 8304 in _format_relationship() ---
# Source:  # Purpose:    Determine whether a method requires
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8304_2 line 8304 in _format_relationship()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8304 in _format_relationship() to detect the mutant
    fail('COND_INV_8304_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_8324_3 (MEDIUM) line 8324 in _format_relationship() ---
# Source:  # Notes:      Orchestrates five detection sub-steps:
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8324_3 line 8324 in _format_relationship()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8324 in _format_relationship() to detect the mutant
...
# Source:  $result->{needs_object} = 0;	# Singleton methods return the singleton instance
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  #             The hashref includes: returns_class,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  #             returns_blessed, returns_new,
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $factory_info{pod_hint} = 1;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_8620_2 (MEDIUM) line 8620 in _detect_singleton_pattern() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8620_2 line 8620 in _detect_singleton_pattern()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8620 in _detect_singleton_pattern() to detect the mutant
    fail('COND_INV_8620_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_8629_2 (MEDIUM) line 8629 in _detect_singleton_pattern() ---
# Source:  # _detect_instance_method
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_8971_2 (MEDIUM) line 8971 in _detect_external_object_dependency() ---
# Source:  # Remove duplicates
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8971_2 line 8971 in _detect_external_object_dependency()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8971 in _detect_external_object_dependency() to detect the mutant
    fail('COND_INV_8971_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_8973_3 (MEDIUM) line 8973 in _detect_external_object_dependency() ---
# Source:  $dependency_info{creates_objects} = [grep { !$seen{$_}++ } @{$dependency_info{creates_objects}}];
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_8973_3 line 8973 in _detect_external_object_dependency()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8973 in _detect_external_object_dependency() to detect the mutant
    fail('BOOL_NEGATE_8973_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_8981_2 (MEDIUM) line 8981 in _detect_external_object_dependency() ---
# Source:  # non-/g match so it cannot have advanced pos, but the while
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_8981_2 line 8981 in _detect_external_object_dependency()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8981 in _detect_external_object_dependency() to detect the mutant
    fail('COND_INV_8981_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_8982_3 (MEDIUM) line 8982 in _detect_external_object_dependency() ---
# Source:  # loop's own /g matches still need to start from the beginning.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_8982_3 line 8982 in _detect_external_object_dependency()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 8982 in _detect_external_object_dependency() to detect the mutant
...
# --- SURVIVOR: BOOL_NEGATE_9030_2 (MEDIUM) line 9030 in _get_parent_class() ---
# Source:  my $doc = $self->{_document};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9030_2 line 9030 in _get_parent_class()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9030 in _get_parent_class() to detect the mutant
    fail('BOOL_NEGATE_9030_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_9033_2 (MEDIUM) line 9033 in _get_parent_class() ---
# Source:  # Look for use parent statements
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9033_2 line 9033 in _get_parent_class()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9033 in _get_parent_class() to detect the mutant
    fail('BOOL_NEGATE_9033_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_9120_3 (MEDIUM) line 9120 in _get_class_for_instance_method() ---
# Source:  # Side effects: None.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9120_3 line 9120 in _get_class_for_instance_method()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9120 in _get_class_for_instance_method() to detect the mutant
    fail('BOOL_NEGATE_9120_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_9282_2 (MEDIUM) line 9282 in _extract_invalid_input_hints() ---
# Source:  push @{ $hints->{invalid_inputs} }, '';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9282_2 line 9282 in _extract_invalid_input_hints()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9282 in _extract_invalid_input_hints() to detect the mutant
    fail('BOOL_NEGATE_9282_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_9287_2 (MEDIUM) line 9287 in _extract_invalid_input_hints() ---
# Source:  push @{ $hints->{invalid_inputs} }, -1;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9287_2 line 9287 in _extract_invalid_input_hints()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9287 in _extract_invalid_input_hints() to detect the mutant
    fail('BOOL_NEGATE_9287_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_9340_2 (MEDIUM) line 9340 in _extract_boundary_value_hints() ---
# Source:  #                      valid_inputs key).
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_9340_2 line 9340 in _extract_boundary_value_hints()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::SchemaExtractor requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::SchemaExtractor');
    # TODO: exercise line 9340 in _extract_boundary_value_hints() to detect the mutant
...
# Source:  # _validate_pod_code_agreement
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip != to ==
TODO: {
...
# Source:  #             return a list of disagreements when
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip != to ==
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_8291_3 line 8291 in _format_relationship() ---
# Source:  } elsif ($rel->{type} eq 'dependency') {
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_8973_3 line 8973 in _detect_external_object_dependency() ---
# Source:  $dependency_info{creates_objects} = [grep { !$seen{$_}++ } @{$dependency_info{creates_objects}}];
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_8982_3 line 8982 in _detect_external_object_dependency() ---
# Source:  # loop's own /g matches still need to start from the beginning.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9030_2 line 9030 in _get_parent_class() ---
# Source:  my $doc = $self->{_document};
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9033_2 line 9033 in _get_parent_class() ---
# Source:  # Look for use parent statements
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9120_3 line 9120 in _get_class_for_instance_method() ---
# Source:  # Side effects: None.
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9282_2 line 9282 in _extract_invalid_input_hints() ---
# Source:  push @{ $hints->{invalid_inputs} }, '';
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9287_2 line 9287 in _extract_invalid_input_hints() ---
# Source:  push @{ $hints->{invalid_inputs} }, -1;
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_9340_2 line 9340 in _extract_boundary_value_hints() ---
# Source:  #                      valid_inputs key).
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
