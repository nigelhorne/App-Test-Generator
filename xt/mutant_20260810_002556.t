...
# Source:  ": $subk is a nested element, not yet supported (",
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
...
# Source:  # compile first and re-embed via regexp_pattern() rather than
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  } elsif($module && $module ne $MODULE_BUILTIN) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
