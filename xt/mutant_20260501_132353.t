...
# --- SURVIVOR: BOOL_NEGATE_442_3 (MEDIUM) line 442 in _load_json_module() ---
# Source:  return $mod if $ok;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_442_3 line 442 in _load_json_module()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 442 in _load_json_module() to detect the mutant
    fail('BOOL_NEGATE_442_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_472_2 (MEDIUM) line 472 in _run_one() ---
# Source:  if($self->{_cover_available}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_472_2 line 472 in _run_one()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 472 in _run_one() to detect the mutant
    fail('COND_INV_472_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_491_3 (MEDIUM) line 491 in _run_one() ---
# Source:  if(!defined($error) && @warnings) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_491_3 line 491 in _run_one()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 491 in _run_one() to detect the mutant
    fail('COND_INV_491_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_500_2 (MEDIUM) line 500 in _run_one() ---
# Source:  if($error && $self->_input_is_valid($input)) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_500_2 line 500 in _run_one()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 500 in _run_one() to detect the mutant
    fail('COND_INV_500_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_506_2 (MEDIUM) line 506 in _run_one() ---
# Source:  if($self->_is_interesting($coverage)) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_506_2 line 506 in _run_one()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 506 in _run_one() to detect the mutant
    fail('COND_INV_506_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_600_2 (MEDIUM) line 600 in _snapshot_cover() ---
# Source:  return %snap;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_600_2 line 600 in _snapshot_cover()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 600 in _snapshot_cover() to detect the mutant
    fail('BOOL_NEGATE_600_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_629_16_> (HIGH) line 629 in _is_interesting() ---
...
#   Numeric boundary flip < to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_629_16_> line 629 in _is_interesting()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 629 in _is_interesting() to detect the mutant
    fail('NUM_BOUNDARY_629_16_>: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_661_2 (MEDIUM) line 661 in _generate_random() ---
# Source:  return $self->_generate_for_schema($self->{schema}{input});
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_661_2 line 661 in _generate_random()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 661 in _generate_random() to detect the mutant
    fail('BOOL_NEGATE_661_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_692_54_> (HIGH) line 692 in _generate_for_schema() ---
...
#   Numeric boundary flip < to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_692_54_> line 692 in _generate_for_schema()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 692 in _generate_for_schema() to detect the mutant
    fail('NUM_BOUNDARY_692_54_>: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_699_35 (MEDIUM) line 699 in _generate_for_schema() ---
# Source:  elsif ($type eq $TYPE_NUMBER)  { return $self->_rand_num($spec)    }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_699_35 line 699 in _generate_for_schema()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 699 in _generate_for_schema() to detect the mutant
    fail('BOOL_NEGATE_699_35: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_724_12_> (HIGH) line 724 in _rand_int() ---
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_724_12_> line 724 in _rand_int()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 724 in _rand_int() to detect the mutant
    fail('NUM_BOUNDARY_724_12_>: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_729_2 (MEDIUM) line 729 in _rand_int() ---
# Source:  return $min + int(rand($max - $min + 1));
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_729_2 line 729 in _rand_int()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 729 in _rand_int() to detect the mutant
    fail('BOOL_NEGATE_729_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_748_2 (MEDIUM) line 748 in _rand_num() ---
# Source:  return $min + rand($max - $min);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_748_2 line 748 in _rand_num()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 748 in _rand_num() to detect the mutant
    fail('BOOL_NEGATE_748_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_773_12_> (HIGH) line 773 in _rand_string() ---
...
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_773_12_> line 773 in _rand_string()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 773 in _rand_string() to detect the mutant
    fail('NUM_BOUNDARY_773_12_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_781_19_> (HIGH) line 781 in _rand_string() ---
...
#   Numeric boundary flip < to >=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_781_19_> line 781 in _rand_string()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 781 in _rand_string() to detect the mutant
    fail('NUM_BOUNDARY_781_19_>: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_931_47_> (HIGH) line 931 in _validate_value() ---
...
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_931_47_> line 931 in _validate_value()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 931 in _validate_value() to detect the mutant
    fail('NUM_BOUNDARY_931_47_>: replace with real assertion');
}
...
# --- SURVIVOR: BOOL_NEGATE_977_3 (MEDIUM) line 977 in _mutate() ---
# Source:  return $self->_generate_random();
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_977_3 line 977 in _mutate()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 977 in _mutate() to detect the mutant
    fail('BOOL_NEGATE_977_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_981_3 (MEDIUM) line 981 in _mutate() ---
# Source:  if($input =~ /^-?\d+$/) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_981_3 line 981 in _mutate()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 981 in _mutate() to detect the mutant
    fail('COND_INV_981_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_982_4 (MEDIUM) line 982 in _mutate() ---
# Source:  return $self->_mutate_int($input);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_982_4 line 982 in _mutate()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 982 in _mutate() to detect the mutant
    fail('BOOL_NEGATE_982_4: replace with real assertion');
}
...
# --- SURVIVOR: NUM_BOUNDARY_1017_12_!= (HIGH) line 1017 in _mutate_int() ---
# Source:  sub { $n == 0 ? 1 : int($n / 2) },
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (1 variant):
#   Numeric boundary flip == to !=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_1017_12_!= line 1017 in _mutate_int()';
    # Suggested boundary values to test: -1, 0, 1
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 1017 in _mutate_int() to detect the mutant
    fail('NUM_BOUNDARY_1017_12_!=: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1071_4 (MEDIUM) line 1071 in _mutate_string() ---
# Source:  return $s unless $len;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1071_4 line 1071 in _mutate_string()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 1071 in _mutate_string() to detect the mutant
    fail('BOOL_NEGATE_1071_4: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_1086_4 (MEDIUM) line 1086 in _mutate_string() ---
# Source:  return $s unless $len;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1086_4 line 1086 in _mutate_string()';
    # NOTE: new() called with no arguments as a starting point.
    # If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
    my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
    # TODO: exercise line 1086 in _mutate_string() to detect the mutant
    fail('BOOL_NEGATE_1086_4: replace with real assertion');
}

# --- LOW DIFFICULTY HINTS (comment stubs) ---

# --- LOW HINT: RETURN_UNDEF_442_3 line 442 in _load_json_module() ---
# Source:  return $mod if $ok;
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_442_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_600_2 line 600 in _snapshot_cover() ---
# Source:  return %snap;
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_661_2 line 661 in _generate_random() ---
# Source:  return $self->_generate_for_schema($self->{schema}{input});
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_661_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_699_35 line 699 in _generate_for_schema() ---
# Source:  elsif ($type eq $TYPE_NUMBER)  { return $self->_rand_num($spec)    }
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_699_35: add assertion here');
...
# --- LOW HINT: RETURN_UNDEF_729_2 line 729 in _rand_int() ---
# Source:  return $min + int(rand($max - $min + 1));
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_729_2: add assertion here');

# --- LOW HINT: RETURN_UNDEF_748_2 line 748 in _rand_num() ---
# Source:  return $min + rand($max - $min);
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_931_3 line 931 in _validate_value() ---
# Source:  return 0 if defined($spec->{min}) && $value < $spec->{min};
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_931_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_932_3 line 932 in _validate_value() ---
# Source:  return 0 if defined($spec->{max}) && $value > $spec->{max};
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_932_3: add assertion here');

# --- LOW HINT: RETURN_UNDEF_977_3 line 977 in _mutate() ---
# Source:  return $self->_generate_random();
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_982_4 line 982 in _mutate() ---
# Source:  return $self->_mutate_int($input);
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_982_4: add assertion here');
...
# --- LOW HINT: RETURN_UNDEF_1071_4 line 1071 in _mutate_string() ---
# Source:  return $s unless $len;
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_1071_4: add assertion here');

# --- LOW HINT: RETURN_UNDEF_1086_4 line 1086 in _mutate_string() ---
# Source:  return $s unless $len;
# Hint:    Mutation survived but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# If App::Test::Generator::CoverageGuidedFuzzer requires constructor arguments, add them here.
# my $obj = new_ok('App::Test::Generator::CoverageGuidedFuzzer');
# ok($obj->..., 'RETURN_UNDEF_1086_4: add assertion here');
