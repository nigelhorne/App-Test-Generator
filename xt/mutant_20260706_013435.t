...
# Source:  $function = $schema->{function} if(exists($schema->{function}));
...
# Source:  $edge_case_array_code = join(', ', map { q_wrap($_) } @edge_case_array);
...
# Source:  my $properties = _generate_transform_properties(
# Hint:    Likely missing edge-case test (boundary value)
...
# Source:  my $setup_code = ($module) ? "BEGIN { use_ok('$module') }" : '';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  if(defined($new) && defined($module)) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # the sentinel string 'undef' means "this param is
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # the caller sees one message rather than four
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  "  Config file: $schema_file\n" .
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Handle scalar shorthand — 'arg1: string' is equivalent to
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
...
# Source:  # Build the call expression for the function under test.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  return "$field_name <- Float(sized => sub { rand($DEFAULT_GENERATOR_RANGE) - $DEFAULT_GENERATOR_RANGE / 2 })";
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  # Only max defined — choose range based on sign of max
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  my $max_len = $spec->{'max'} // $DEFAULT_MAX_STRING_LEN;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Data::Random::String::Matches for pattern-aware generation
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  : "\$result eq " . perl_quote($expected),
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
